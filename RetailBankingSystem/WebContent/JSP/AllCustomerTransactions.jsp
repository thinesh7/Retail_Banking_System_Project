...
<%@page import="com.tcs.Models.Transaction"%>
...
<% List<Transaction> trlist=(List<Transaction>)request.getAttribute("list");%>

<article>

<h3 Style="text-align:center;font-size:20px ">Transaction Status</h3>
...
<button type="submit" name="action" value="searchbytxnIdandAccountid">Search</button></td>
</tr>
</table>
</form>
...
<tr>
        <th style="column-width:120px">Transaction ID</th>
        <th style="column-width:150px">Account ID</th>
        <th style="column-width:120px">Message</th>
        <th style="column-width:100px">Amount</th>
...
<td> <%=tr.getAccountid()%> </td> 
<td> <%=tr.getMessage()%> </td>
<td><%=tr.getAmount()%></td>
<td><%=tr.getLastupdated()%></td>
</tr>
