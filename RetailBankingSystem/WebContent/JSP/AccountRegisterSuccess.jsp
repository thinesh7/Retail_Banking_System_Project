...
<br>
<br>
<h3 style="color:green">Account Creation Initiated Successfully</h3><br>
<p>Customer ID:<%=acc.getCustid() %> </p>
<p>Account Type:<%=acc.getAccounttype()%></p>
<p>Amount:<%=acc.getDeposit() %></p>
