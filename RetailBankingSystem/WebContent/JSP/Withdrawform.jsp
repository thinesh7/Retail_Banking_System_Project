...
<h3 Style="text-align:center;font-size:20px ">Withdrawn form</h3>
...
<tr><td>Enter the Amount to be withdraw:</td>
<td><input type="number" name="amount" required="required"></td>
</tr>
<tr><td><button type="submit" name="action" value="withdraw">Withdraw</button></td>
