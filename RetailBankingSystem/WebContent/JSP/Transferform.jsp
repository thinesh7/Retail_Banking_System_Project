...
<h3 Style="text-align:center;font-size:20px ">Transfer form</h3>
...
<table>
<tr><td>Source Account ID:</td><td><input type="text" name="sourceaccid" value="<%=accid%>" readonly="readonly"></td></tr>
<tr><td>Target Account ID:</td><td><input type="text" name="targetaccid" required="required"></td>
<tr><td>Enter the Amount to be Transfer:</td>
<td><input type="number" name="amount" required="required"></td>
</tr>
<tr><td><button type="submit" name="action" value="Transfer">Submit</button></td>
<td><button type="submit" name="action" value="transferCancel">Cancel</button></td></tr></table>
